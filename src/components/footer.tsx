...
const Footer = () => {
    return (
        <footer>
            ...
            <hr />
            <div className="d-flex align-items-center justify-content-center justify-content-lg-between w-100 px-3" style={{ height: "40px" }}>
                <a className='text-white small text-start position-lg-relative position-absolute start-0' href="/gestao-access">
